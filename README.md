...
Varje dokumentations område är grovt basserat på båtsportssjökorten. Dock skall varje område ha max 100 hastighetsbegränsningar (bounderies) då många plotters har en begränsning på 100 boundaries. För att dokumentera sina utvalda boundaries filer så kan man spara dem under Personliga filer katalogen.
